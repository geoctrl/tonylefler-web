      ...
      return (
        <div className="flex items-center gap-6">
          <div className="flex flex-col items-center gap-2">
            <Toggle formSize="sm" checked={small} onValueChange={setSmall} />
            <span className="text-xs opacity-50">Small</span>
          </div>
          <div className="flex flex-col items-center gap-2">
            <Toggle formSize="md" checked={medium} onValueChange={setMedium} />
            <span className="text-xs opacity-50">Medium</span>
          </div>
          <div className="flex flex-col items-center gap-2">
            <Toggle formSize="lg" checked={large} onValueChange={setLarge} />
...
```tsx
<Toggle formSize="sm" checked={checked} onValueChange={setChecked} />
<Toggle formSize="md" checked={checked} onValueChange={setChecked} /> {/* default */}
<Toggle formSize="lg" checked={checked} onValueChange={setChecked} />
```
      ...
      return (
        <div className="flex flex-col gap-4">
          <div className="flex items-center justify-between">
            ...
            <Toggle checked={notifications} onValueChange={setNotifications} />
          </div>
          <div className="flex items-center justify-between">
            <div>
            ...
            <Toggle checked={darkMode} onValueChange={setDarkMode} />
          </div>
        </div>
      );
    }
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex items-center gap-3">
            <Toggle
              ...
              onValueChange={handleToggle('spellCheck')}
            />
          ...
          <div className="flex items-center gap-3">
            <Toggle
              ...
              onValueChange={handleToggle('lineNumbers')}
            />
  ...
  {(() => {
    function Demo() {
      ...
      return (
        <div className="flex flex-col gap-3">
          <div className="flex items-center gap-3">
            <Toggle checked={enabled} onValueChange={handleChange} />
